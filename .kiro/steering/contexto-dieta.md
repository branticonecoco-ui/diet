...
# Contexto maestro de la planificación alimentaria

Este archivo conserva el contexto, los objetivos y el razonamiento que no deben aparecer en el planning imprimible. Antes de proponer o realizar cualquier cambio, una conversación futura debe leer este documento y los tres archivos de trabajo referenciados al final.

## Regla principal para futuras modificaciones

1. No modificar el menú basándose únicamente en una comida aislada: revisar primero el día completo y la semana.
2. Mantener `plan-semanal.md` limpio, breve e imprimible, con alimentos, cantidades y horarios, pero sin explicaciones nutricionales.
3. Colocar instrucciones culinarias en los recetarios y razonamientos, supuestos, decisiones e incertidumbres en este archivo.
4. Si cambia una cantidad o alimento del planning, actualizar también el recetario correspondiente y revisar proteína, energía, fibra, calcio, hierro, zinc, B12, yodo, vitamina D y omega-3.
5. No afirmar que un nutriente está garantizado sin calcularlo con los productos y etiquetas reales.
6. No añadir suplementos automáticamente. Vincular cualquier recomendación de suplementación a una necesidad concreta, una analítica o consejo sanitario.
7. No inventar información personal. Lo que no conste aquí se considera desconocido y debe preguntarse si resulta decisivo.

## Perfil conocido

- Hombre de 45 años.
- Altura: 1,80 m.
- Peso comunicado: 71 kg.
- IMC orientativo: 21,9.
- Objetivo principal: comer de la forma más saludable y nutritiva posible.
- Objetivo de peso: mantenimiento aproximado; no busca adelgazar ni ganar peso, aunque una pequeña pérdida no le preocupa.
- Trabaja desde casa y dispone de bastante tiempo para cocinar.
- Situación de partida: lleva tiempo sin actividad física y se considera sedentario.
- Actividad prevista: comenzar natación progresivamente y llegar aproximadamente a tres sesiones semanales de 30 minutos.
- Días provisionales de piscina: martes, jueves y sábado.
...
Este repositorio contiene intencionadamente algunos datos físicos y de estilo de vida porque el usuario pidió conservarlos para futuras conversaciones. No añadir nombres, direcciones, contactos u otros datos identificativos que no sean necesarios.

## Alimentos y productos disponibles

- Aproximadamente 2 kg de arándanos congelados al iniciar el plan.
- Germen de trigo.
- Semillas de lino y chía.
- Jamón cocido que desea terminar antes de dejar de comprarlo como opción habitual.
- Está familiarizado con desayunos de yogur, avena y arándanos, aunque actualmente desayunaba poco.
...
El usuario quiere que las cremas vegetales y el desayuno concentren la mayor parte posible de:

- diversidad vegetal;
- vitaminas y minerales procedentes de alimentos;
- fibra y sustratos prebióticos;
- carotenoides y pigmentos vegetales;
- polifenoles;
- crucíferas, hojas verdes, alliums, setas, legumbres, semillas y frutos secos.

El resto del día debe centrarse más en:

- proteína suficiente y de buena calidad;
- energía necesaria para mantener aproximadamente el peso;
- nutrientes ausentes o poco fiables en una alimentación basada principalmente en vegetales: B12, EPA/DHA, yodo y vitamina D;
- calcio, colina, selenio, hierro y zinc mediante fuentes seleccionadas y comprobables.
...
El desayuno funciona como segundo núcleo de micronutrientes junto con las cremas. Combina:

- lácteo alto en proteína, kéfir o bebida de soja enriquecida;
- avena y, algunos días, germen de trigo;
- arándanos u otra fruta;
- lino, chía o frutos secos;
...
- arroz, quinoa, patata, pasta, bulgur o cebada;
- una porción moderada de verduras enteras o ensalada para mantener masticación y diversidad sin depender exclusivamente de triturados.
...
Las cifras son hipótesis de diseño, no una prescripción clínica:
...
### Muy reforzados por cremas y desayuno
...
- ALA procedente de lino, chía y nueces.
- Hierro vegetal, cobre y manganeso.
...
La carga de fibra y volumen es alta. Si aparecen hinchazón, dolor, cambios intestinales o saciedad que impida comer suficiente:
...
- Días provisionales: martes, jueves y sábado.
- Progresión esperada: comenzar con menos y llegar a unos 30 minutos por sesión.
- Para sesiones recreativas de esa duración normalmente basta agua.
- No hace falta batido proteico ni bebida deportiva de forma rutinaria.
- Evitar la crema inmediatamente antes de nadar por su volumen y fibra.
- Si la piscina queda entre comida y cena, se puede trasladar la fruta de la comida para tomarla antes.
- Si aumenta el hambre o baja el peso de forma sostenida, aumentar carbohidrato o energía alrededor de las sesiones.

## Seguimiento necesario

Durante las primeras 2–3 semanas de uso real se deben observar:

- promedio semanal de peso, no fluctuaciones de un solo día;
- hambre y saciedad;
- energía y concentración trabajando;
- digestión y tolerancia a legumbres, alliums y crucíferas;
- recuperación y rendimiento en piscina;
- facilidad de compra, cocina, congelación y cumplimiento;
- aceptación del volumen de cada crema.

Si el peso baja de manera continua sin buscarlo, aumentar energía en bloques modestos mediante pan, arroz, patata, avena, AOVE o frutos secos. Si sube de forma sostenida y no se desea, revisar primero aceite, pan, cereales y toppings, sin recortar automáticamente verduras o proteína.
